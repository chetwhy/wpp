...
import cn.yccoding.wpp.sdk.WXPayConstants.SignType;
...
public class WXPay {
     ...
     * @return
     */
    public Map<String, String> batchQueryComment(Map<String,String> reqData) throws Exception {
        return this.batchQueryComment(reqData, this.config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
     ...
     * @return
     */
    public Map<String, String> batchQueryComment(Map<String,String> reqData,int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url;
        if (this.useSandbox) {
            url = WXPayConstants.SANDBOX_BATCHQUERYCOMMENT_URL_SUFFIX;
        }
        else {
            url = WXPayConstants.BATCHQUERYCOMMENT_URL_SUFFIX;
        }
        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
